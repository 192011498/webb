...
<div class="single-product mt-150 mb-150">
    <div class="container">
        <div class="row">
            ...
            $sql = "SELECT image,id,price,availabilty FROM flowers WHERE id = $id";
            ...
            if ($result->num_rows > 0) {
                ...
                <div class="container mt-5">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <form action="update_flowers.php" method="post" enctype="multipart/form-data">
                                ...
                                function deleteProduct(productId) {
                                    $.ajax({
                                        ...
                                        success: function(response) {
                                            ...
                                            window.location.href = 'flowerlist.php';
                                        },
...
if(isset($_POST['delete_id'])) {
    ...
    // Example:
    $delete_sql = "DELETE FROM flowers WHERE id = $delete_id";
